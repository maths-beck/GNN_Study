...
| Project | Objective | Key Technologies | Topics Covered |
| :--- | :--- | :--- | :--- |
| **[GNN_From_Scratch](https://github.com/maths-beck/GNN_Study/tree/main/GNN_from_scratch)** | Implement core GNN architectures without high-level frameworks. | NumPy, Autograd, NetworkX | Message Passing, GCN, GAT, Node Classification |
